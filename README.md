...
|                블록 조회                 |                블록 추가                 |
| :--------------------------------------: | :--------------------------------------: |
| <img width="390" src="assets/preview/블록 조회.gif"> | <img width="390" src="assets/preview/블록 추가.gif"> |

|                블록 연결                 |                블록 삭제                 |
| :--------------------------------------: | :--------------------------------------: |
| <img width="390" src="assets/preview/블록 연결.gif"> | <img width="390" src="assets/preview/블록 삭제.gif"> |
...
|                연결성 확인                 |                 순환 생성 방지                 |
| :----------------------------------------: | :--------------------------------------------: |
| <img width="390" src="assets/preview/연결성 확인.gif"> | <img width="390" src="assets/preview/순환 생성 방지.gif"> |
...
| :---: | :---: |
| <img width="390" src="assets/start-server.gif"> | <img width="390" src="assets/add-search-api.gif"> | 

| API 테스트 | API 삭제 및 서버 종료 |
| :---: | :---: |
| <img width="390" src="assets/test-api.gif"> | <img width="390" src="assets/delete-api.gif">
</br>
